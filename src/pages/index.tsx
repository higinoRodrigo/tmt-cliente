  ...
  return (
    <div className="flex lg:gap-20 gap-2 flex-wrap items-center justify-center -mb-4">
      <div className="flex flex-col items-start">
        <div className="bg-[#ffffff] py-16 px-32 rounded-lg shadow-md min-w-[200px] flex md:flex-row flex-col gap-10">
          <Link href='/servicos'>
            <div className="
              flex flex-col items-center justify-center gap-2
              w-36 h-36
              text-lg border p-4 px-3 rounded-lg
              shadow bg-[#7c1c1e] text-[#f8f8f8]
              transform transition duration-200
              cursor-pointer bg-[url('/bg.png')] bg-cover
              hover:opacity-80
            ">
